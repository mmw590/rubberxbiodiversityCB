...
# Scenario 3a: Compromise (Compromising biodiversity prioritise production), averaged suit, vuln (vulnT), acc and carbon (optim4). ####
...
fwrite(scen_df, 'output/scen_df3a.csv')
...
fwrite(spprangeloss_df, 'output/spprangelosstbl_scen3a.csv')

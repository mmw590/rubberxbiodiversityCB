...
# Scenario 1c: Production-driven, order of decreasing suitability and increasing acc  ####
...
fwrite(scen_df, 'output/scen_df1.csv')
...
fwrite(spprangeloss_df, 'output/spprangelosstbl_scen1.csv')

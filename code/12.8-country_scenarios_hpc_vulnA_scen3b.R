######## 08-country_scenarios_hpc_vulnA_scen3b.R ############
...
scen_in <- scen_in[ , .(suit, forest, conv.ord, comprom.vulnA.2, optim4.vulnA)]
...
fwrite(scen_df, 'output/countrysim_scen_df_vulnA_3b.csv')
...
fwrite(spprangeloss_df, 'output/countrysim_spprangelosstbl_vulnA_scen3b.csv')

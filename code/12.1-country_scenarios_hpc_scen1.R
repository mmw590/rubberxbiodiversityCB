######## 08-country_scenarios_hpc_scen1.R ############
...
# Scenario 1: Production-driven, order of decreasing suitability and increasing acc  ####
...
fwrite(scen_df, 'output/countrysim_scen_df1.csv')
...
fwrite(spprangeloss_df, 'output/countrysim_spprangelosstbl_scen1.csv')

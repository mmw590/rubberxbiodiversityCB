######## 08-country_scenarios_hpc_vulnA_scen3c.R ############
...
scen_in <- scen_in[ , .(suit, forest, conv.ord, comprom.vulnA.3, optim4.vulnA)]
...
fwrite(scen_df, 'output/countrysim_scen_df_vulnA_3c.csv')
...
fwrite(spprangeloss_df, 'output/countrysim_spprangelosstbl_vulnA_scen3c.csv')

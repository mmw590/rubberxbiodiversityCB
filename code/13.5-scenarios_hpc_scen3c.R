...
# Scenario 3c: Compromise (Compromise both equally), averaged suit, vuln (vulnT), acc and carbon (optim4). ####
...
fwrite(scen_df, 'output/scen_df3c.csv')
...
fwrite(spprangeloss_df, 'output/spprangelosstbl_scen3c.csv')

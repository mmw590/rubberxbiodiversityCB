...
# Scenario 2d: Conservation-driven, order of increasing vulnT & aboveground carbon ####
...
fwrite(scen_df, 'output/scen_df2.csv')
...
fwrite(spprangeloss_df, 'output/spprangelosstbl_scen2.csv')

######## 06-scenarios_hpc_scen3a_vulnA.R ############
...
# Scenario 3a: Compromise (Compromising biodiversity prioritise production), averaged suit, vuln (vulnA), acc and carbon (optim4). ####
scen_in <- suit_vuln_vals3[ , .(suit, forest, comprom.vulnA.1, optim4.vulnA)]
...
fwrite(scen_df, 'output/scen_df_vulnA_3a.csv')
...
fwrite(spprangeloss_df, 'output/spprangelosstbl_vulnA_scen3a.csv')

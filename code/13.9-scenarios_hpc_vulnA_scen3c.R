######## 06-scenarios_hpc_scen3c_vulnA.R ############
...
# Scenario 3c: Compromise (Compromising both equally), averaged suit, vuln (vulnA), acc and carbon (optim4). ####
scen_in <- suit_vuln_vals3[ , .(suit, forest, comprom.vulnA.3, optim4.vulnA)]
...
fwrite(scen_df, 'output/scen_df_vulnA_3c.csv')
...
fwrite(spprangeloss_df, 'output/spprangelosstbl_vulnA_scen3c.csv')

######## 08-country_scenarios_hpc_vulnA_scen3a.R ############
...
scen_in <- scen_in[ , .(suit, forest, conv.ord, comprom.vulnA.1, optim4.vulnA)]
...
fwrite(scen_df, 'output/countrysim_scen_df_vulnA_3a.csv')
...
fwrite(spprangeloss_df, 'output/countrysim_spprangelosstbl_vulnA_scen3a.csv')
